<?php
    ...
    function sentInvoice($conn,$order_id) {
        ...
        $user_order = mysqli_fetch_assoc(mysqli_query($conn,"select `order`.*,users.name,users.email from `order`,users where users.id=`order`.user_id and `order`.id='$order_id'"));
                    ...
                    <td class="email-body" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <div class="f-fallback">
                                <h1 class="text-capitalize">Hi '.$user_order['name'].',</h1>
