                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th class="product-remove">Add Item</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="product-thumbnail"><a href="#"><img
                                                src="./media/product/<?php echo $row['image']?>" /></a></td>
                                    ...
                                    <td><a class="fr__btn" href="javascript:void(0)" onclick="manage_cart('<?php echo $row['id']?>','add')">Add to Cart</a></td>
